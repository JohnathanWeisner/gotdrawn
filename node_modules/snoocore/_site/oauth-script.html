...
<html>
  ...
  <link rel="canonical" href="http://tsenior.com/snoocore/oauth-script.html">
...
<p>See an example <a href="https://github.com/trevorsenior/snoocore-examples/blob/master/node/oauth-script.js">here</a>.</p>

<p>Script based authentication is the easiest way to authenticate using OAuth with the Reddit API in Node.js</p>

<h2 id="supported-apps">Supported Apps</h2>

<p>Explicit based OAuth will only work if you app is a <code>web</code> or <code>installed</code> application.</p>
...
<p>The only caveat is that this method can only authenticate users listed as developers for the given application. Because of this, it makes it a great choice for bots.</p>
</div>
    </div>
