...
<html>
  ...
  <title>Snoocore running tests</title>
  ...
  <link rel="canonical" href="http://tsenior.com/snoocore/tests.html">
  ...
  <li>Resources
    <ul>
      ...
      <div class="my-content"><p>Change in progress: <a href="https://github.com/trevorsenior/snoocore/issues/73">https://github.com/trevorsenior/snoocore/issues/73</a></p>

<h1 id="running-tests">Running Tests</h1>

<h2 id="configuring-the-tests-with-your-information">Configuring the tests with your information</h2>

<ol>
<li>Visit the Reddit Wiki on how to make an application: <a href="https://github.com/reddit/reddit/wiki/OAuth2">https://github.com/reddit/reddit/wiki/OAuth2</a>

<ul>
<li>For the redirect uri, use <code>http://localhost:3000</code></li>
</ul></li>
<li>Copy your information into <code>./test/testConfig</code></li>
</ol>

<h2 id="running-the-tests">Running the tests</h2>

<p>Tests must be ran against your own API key, and reddit username &amp; password. The tests conform to the <a href="https://github.com/reddit/reddit/wiki/API#rules">rules laid out on the Reddit API Wiki</a> and therefore are a tad bit slow.</p>
