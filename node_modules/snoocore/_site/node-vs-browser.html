...
<html>
  ...
  <title>Snoocore Node vs Browser</title>
  ...
  <link rel="canonical" href="http://tsenior.com/snoocore/node-vs-browser.html">
  ...
  <li>Resources
    <ul>
      ...
      <div class="my-content"><h1 id="node-vs-browser-differences">Node vs Browser differences</h1>

<p>The syntax is the same in both Node and in the Browser. The differences lie in restrictions (what will work, and what will not).</p>

<h2 id="node.js">Node.js</h2>

<p>Can not use Implicit based OAuth, otherwise there are no restrictions.</p>

<h2 id="browser-javascript">Browser JavaScript</h2>

<p>Implicit based OAuth is the only way to make authenticated calls when using browser JavaScript unless you are writing an extension.</p>

<h2 id="browser-extensions">Browser Extensions</h2>

<p>Most browsers allow you to write extensions that can white list domains and allow more freedom in how calls are made to them. You will need to white list the following domains in your extension:</p>
...
<p>Implicit based OAuth will work in a browser extension, but once you whitelist the above domains it is possible to use explicit based OAuth as well.</p>
</div>
    </div>
